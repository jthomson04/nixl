...
static nixlBackendPlugin plugin = {NIXL_PLUGIN_API_VERSION, create_posix_engine,
        destroy_posix_engine, get_plugin_name, get_plugin_version, get_backend_options,
        get_backend_mems};
