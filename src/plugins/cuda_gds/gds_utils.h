...
public:
    ...
    nixl_status_t addToBatch(CUfileHandle_t fh, void* buffer, size_t size, size_t file_offset,
...
public:
    gdsUtil() {}
    ~gdsUtil() {}
    nixl_status_t registerFileHandle(
            int fd, size_t size, std::string metaInfo, gdsFileHandle &handle);
