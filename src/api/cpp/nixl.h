...
public:
    ...
    nixl_status_t createBackend(
            const nixl_backend_t &type, const nixl_b_params_t &params, nixlBackendH*&backend);
    /**
    ...
    nixl_status_t registerMem(
            const nixl_reg_dlist_t &descs, const nixl_opt_args_t* extra_params = nullptr);
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t makeConnection(
            const std::string &remote_agent, const nixl_opt_args_t* extra_params = nullptr);
     ...
     * @return nixl_status_t    Error code if call was not successful
     */
    nixl_status_t prepXferDlist(const std::string &agent_name, const nixl_xfer_dlist_t &descs,
            nixlDlistH*&dlist_hndl, const nixl_opt_args_t* extra_params = nullptr) const;
    /**
     ...
     * @return nixl_status_t    Error code if call was not successful
     */
    nixl_status_t makeXferReq(const nixl_xfer_op_t &operation, const nixlDlistH* local_side,
     ...
     * @return nixl_status_t  Error code if call was not successful
     */
    nixl_status_t createXferReq(const nixl_xfer_op_t &operation,
    ...
    nixl_status_t postXferReq(
            nixlXferReqH* req_hndl, const nixl_opt_args_t* extra_params = nullptr) const;
     ...
     * @return nixl_status_t NIXL_IN_PROG or error code if call was not successful
     */
    nixl_status_t getXferStatus(nixlXferReqH* req_hndl);
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t queryXferBackend(const nixlXferReqH* req_hndl, nixlBackendH*&backend) const;
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t releaseXferReq(nixlXferReqH* req_hndl);
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t releasedDlistH(nixlDlistH* dlist_hndl) const;
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t getNotifs(
            nixl_notifs_t &notif_map, const nixl_opt_args_t* extra_params = nullptr);
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t genNotif(const std::string &remote_agent, const nixl_blob_t &msg,
     ...
     * @return nixl_status_t       Error code if call was not successful
     */
    nixl_status_t getLocalPartialMD(const nixl_reg_dlist_t &descs, nixl_blob_t &str,
            const nixl_opt_args_t* extra_params = nullptr) const;
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t sendLocalMD(const nixl_opt_args_t* extra_params = nullptr) const;
     ...
     * @return nixl_status_t       Error code if call was not successful
     */
    nixl_status_t sendLocalPartialMD(
            const nixl_reg_dlist_t &descs, const nixl_opt_args_t* extra_params = nullptr) const;
     ...
     * @return nixl_status_t    Error code if call was not successful
     */
    nixl_status_t fetchRemoteMD(
            const std::string remote_name, const nixl_opt_args_t* extra_params = nullptr);
     ...
     * metadata. If IP is unspecified, this will invalidate from the metadata server. Port can be
     * specified or defaults to default_comm_port.
     *
     * @return nixl_status_t    Error code if call was not successful
     */
    nixl_status_t invalidateLocalMD(const nixl_opt_args_t* extra_params = nullptr) const;
