...
PYBIND11_MODULE(_bindings, m)
{
    ...
    m.doc() =
            "pybind11 NIXL plugin: Implements NIXL descriptors and lists, as well as bindings of "
            "NIXL CPP APIs";
    ...
    py::class_<nixl_xfer_dlist_t>(m, "nixlXferDList")
            .def(py::init<nixl_mem_t, bool, int>(), py::arg("type"), py::arg("sorted") = false,
                    py::arg("init_size") = 0)
            .def(py::init([](nixl_mem_t mem, std::vector<py::tuple> descs, bool sorted) {
                ...
                for (long unsigned int i = 0; i < descs.size(); i++)
                    new_list[i] = nixlBasicDesc(descs[i][0].cast<uintptr_t>(),
                            descs[i][1].cast<size_t>(), descs[i][2].cast<uint64_t>());
            ...
            .def(py::self == py::self)
            .def("__getitem__",
                    [](nixl_xfer_dlist_t &list,
                            unsigned int  i) -> std::tuple<uintptr_t, size_t, uint64_t> {
            ...
            .def("__setitem__",
                    [](nixl_xfer_dlist_t &list, unsigned int i, const py::tuple &desc) {
                        list[i] = nixlBasicDesc(desc[0].cast<uintptr_t>(), desc[1].cast<size_t>(),
                                desc[2].cast<uint64_t>());
                    })
            .def("addDesc",
                    [](nixl_xfer_dlist_t &list, const py::tuple &desc) {
                        list.addDesc(nixlBasicDesc(desc[0].cast<uintptr_t>(),
                                desc[1].cast<size_t>(), desc[2].cast<uint64_t>()));
                    })
            .def("append",
                    [](nixl_xfer_dlist_t &list, const py::tuple &desc) {
                        list.addDesc(nixlBasicDesc(desc[0].cast<uintptr_t>(),
            ...
            .def("index",
                    [](nixl_xfer_dlist_t &list, const py::tuple &desc) {
                        int ret = (nixl_status_t)list.getIndex(
                                nixlBasicDesc(desc[0].cast<uintptr_t>(), desc[1].cast<size_t>(),
                                        desc[2].cast<uint64_t>()));
    ...
    py::class_<nixl_reg_dlist_t>(m, "nixlRegDList")
            ...
            .def(py::init([](nixl_mem_t mem, std::vector<py::tuple> descs, bool sorted) {
                ...
                for (long unsigned int i = 0; i < descs.size(); i++)
                    new_list[i] =
                            nixlBlobDesc(descs[i][0].cast<uintptr_t>(), descs[i][1].cast<size_t>(),
                                    descs[i][2].cast<uint64_t>(), descs[i][3].cast<std::string>());
                if (sorted) new_list.verifySorted();
                return new_list;
            }),
                    py::arg("type"), py::arg("descs"), py::arg("sorted") = false)
            ...
            .def(py::self == py::self)
            .def("__getitem__",
                    [](nixl_reg_dlist_t &list, unsigned int i)
            ...
            .def("__setitem__",
                    [](nixl_reg_dlist_t &list, unsigned int i, const py::tuple &desc) {
                        list[i] = nixlBlobDesc(desc[0].cast<uintptr_t>(), desc[1].cast<size_t>(),
            ...
            .def("index",
                    [](nixl_reg_dlist_t &list, const py::tuple &desc) {
                        int ret = list.getIndex(
                                nixlBlobDesc(desc[0].cast<uintptr_t>(), desc[1].cast<size_t>(),
                                        desc[2].cast<uint64_t>(), desc[3].cast<std::string>()));
                        if (ret < 0) throw_nixl_exception((nixl_status_t)ret);
                        return ret;
                    })
    ...
    py::class_<nixlAgent>(m, "nixlAgent")
            ...
            .def("getPluginParams",
                    [](nixlAgent &agent, const nixl_backend_t type)
                            -> std::pair<nixl_b_params_t, std::vector<std::string>> {
            ...
            .def("getBackendParams",
                    [](nixlAgent &agent, uintptr_t backend)
                            -> std::pair<nixl_b_params_t, std::vector<std::string>> {
                        nixl_b_params_t          params;
                        nixl_mem_list_t          mems;
                        std::vector<std::string> mems_vec;
            ...
            .def(
                    "registerMem",
                    [](nixlAgent &agent, nixl_reg_dlist_t descs,
            ...
            .def(
                    ...
                    py::arg("descs"), py::arg("backends") = std::vector<uintptr_t>({}))
            .def("makeConnection",
                    [](nixlAgent &agent, const std::string &remote_agent,
            ...
            .def(
                    "prepXferDlist",
                    [](nixlAgent &agent, std::string &agent_name, const nixl_xfer_dlist_t &descs,
                    ...
                    py::arg("agent_name"), py::arg("descs"),
                    py::arg("backend") = std::vector<uintptr_t>({}))
            .def(
                    "makeXferReq",
                    [](nixlAgent &agent, const nixl_xfer_op_t &operation, uintptr_t local_side,
                            const std::vector<int> &local_indices, uintptr_t remote_side,
                            const std::vector<int> &remote_indices, const std::string &notif_msg,
                            std::vector<uintptr_t> backends, bool skip_desc_merge) -> uintptr_t {
                        ...
                        throw_nixl_exception(agent.makeXferReq(operation, (nixlDlistH*)local_side,
                                local_indices, (nixlDlistH*)remote_side, remote_indices, handle,
                                &extra_params));

                        return (uintptr_t)handle;
                    },
                    py::arg("operation"), py::arg("local_side"), py::arg("local_indices"),
            ...
            .def(
                    "createXferReq",
                    [](nixlAgent &agent, const nixl_xfer_op_t &operation,
                            const nixl_xfer_dlist_t &local_descs,
                            const nixl_xfer_dlist_t &remote_descs, const std::string &remote_agent,
                        ...
                        nixl_status_t ret = agent.createXferReq(operation, local_descs,
                                remote_descs, remote_agent, handle, &extra_params);

                        throw_nixl_exception(ret);
                        return (uintptr_t)handle;
                    },
                    py::arg("operation"), py::arg("local_descs"), py::arg("remote_descs"),
                    py::arg("remote_agent"), py::arg("notif_msg") = std::string(""),
                    py::arg("backend") = std::vector<uintptr_t>({}))
            .def(
                    "postXferReq",
            ...
            .def(
                    "getNotifs",
                    [](nixlAgent &agent, nixl_py_notifs_t &notif_map,
            ...
            .def(
                    "genNotif",
                    [](nixlAgent &agent, const std::string &remote_agent, const std::string &msg,
                            std::vector<uintptr_t> backends) {
                        nixl_opt_args_t extra_params;
                        nixl_status_t   ret;
                    ...
                    py::arg("remote_agent"), py::arg("msg"),
            ...
            .def(
                    "getLocalPartialMD",
                    [](nixlAgent &agent, nixl_reg_dlist_t descs, bool inc_conn_info,
                        ...
                        throw_nixl_exception(
                                agent.getLocalPartialMD(descs, ret_str, &extra_params));
                        return py::bytes(ret_str);
                    },
                    py::arg("descs"), py::arg("inc_conn_info") = false,
                    py::arg("backends") = std::vector<uintptr_t>({}))
            .def("loadRemoteMD",
            ...
            .def(
                    "sendLocalPartialMD",
                    [](nixlAgent &agent, nixl_reg_dlist_t descs, bool inc_conn_info,
                            std::vector<uintptr_t> backends, std::string ip_addr, int port) {
                        std::string ret_str("");
            ...
            .def(
                    "fetchRemoteMD",
                    [](nixlAgent &agent, std::string remote_agent, std::string ip_addr, int port) {
                        nixl_opt_args_t extra_params;
                    ...
                    py::arg("remote_agent"), py::arg("ip_addr") = std::string(""),
                    py::arg("port") = 0)
            .def(
                    "invalidateLocalMD",
                    [](nixlAgent &agent, std::string ip_addr, int port) {
