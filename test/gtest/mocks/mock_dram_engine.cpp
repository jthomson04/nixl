...
nixl_status_t MockDramBackendEngine::registerMem(
...
nixl_status_t MockDramBackendEngine::loadRemoteConnInfo(
...
nixl_status_t MockDramBackendEngine::loadRemoteMD(const nixlBlobDesc &input,
        const nixl_mem_t &nixl_mem, const std::string &remote_agent, nixlBackendMD*&output)
{
    sharedState++;
    return NIXL_SUCCESS;
}

nixl_status_t MockDramBackendEngine::loadLocalMD(nixlBackendMD* input, nixlBackendMD*&output)
{
    sharedState++;
    return NIXL_SUCCESS;
}
...
nixl_status_t MockDramBackendEngine::genNotif(
